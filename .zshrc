...
alias conwifi='nmcli c up'
alias wifiscan='iwlist scan | grep SSID'
...
alias lauv_music='mpv ~/Music/Lauv* --shuffle'
alias setHDMI='xrandr --auto --output "HDMI1" --mode 1024x768 --left-of "eDP1"'
alias ls='lsd'
